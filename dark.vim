...
" The dark.vim theme:
let s:airline_a_normal   = [ '#303030' , '#ea81ff' , 236 , 13 ]
let s:airline_b_normal   = [ '#b2b2b2' , '#3a3a3a' , 249 , 237 ]
let s:airline_c_normal   = [ '#ea81ff' , '#444444' , 13  , 238 ]
...
let g:airline#themes#dark#palette.normal_modified = {
      \ 'airline_c': [ '#ea81ff' , '#444444' , 13     , 238      , ''     ] ,
      \ }

let s:airline_a_insert = [ '#444444' , '#8ec07c' , 238  , 1  ]
let s:airline_b_insert = [ '#b2b2b2' , '#3a3a3a' , 249 , 237  ]
let s:airline_c_insert = [ '#8ec07c' , '#444444' , 1  , 238  ]
...
let g:airline#themes#dark#palette.insert_paste = {
      \ 'airline_a': [  '#c34d50'  , '#444444' , 9 , 238     , ''     ] ,
      \ }

let s:airline_a_replace = [ '#303030'   , '#c34d50' , 236  , 9  , '' ]
let s:airline_b_replace = [ '#b2b2b2' , '#3a3a3a' , 249 , 237 , '' ]
let s:airline_c_replace  = [ '#c34d50' , '#444444' , 9 , 238 , '' ]
...
let s:airline_a_visual = [ '#303030' , '#7892ac' , 236 , 12 ]
let s:airline_b_visual = [ '#b2b2b2' , '#3a3a3a' , 249 , 237 ]
let s:airline_c_visual = [ '#7892ac' , '#444444' , 12 , 238  ]
