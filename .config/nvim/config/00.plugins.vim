...
if dein#load_state('/home/ryanm/.cache/dein')
    ...
    call dein#add('kristijanhusak/vim-dirvish-git', {'on_cmd': 'Dirvish'})
    call dein#add('fsharpasharp/vim-dirvinist', {'on_cmd': 'Dirvish'})
    call dein#add('bounceme/remote-viewer', {'on_cmd': 'Dirvish'})
