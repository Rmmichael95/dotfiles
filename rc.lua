...
tags = {
    names = {"main", "work", "overflow", "gaming", "misc"}
}
for s = 1, screen.count() do
...
globalkeys = awful.util.table.join(
    -- My bindings
    --`awful.key({ }, "Caps_Lock", ./caps_lockIndicator.sh )
...
--
---- Startup programs
awful.util.spawn_with_shell("xscreensaver") -- start xscreensaver
awful.util.spawn_with_shell("xcompmgr -c &") -- start xscreensaver
awful.util.spawn_with_shell("nm-applet --sm-disable &") -- start xscreensaver
-- awful.util.spawn_with_shell("blueman-applet") -- start bluetooth widget
